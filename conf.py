...
# If True, the output of todo directives will show up
todo_include_todos = True

# If True, todo emits warning for each TODO entries.
...
# documentation.
#html_theme_options = {'sidebarbgcolor': '#105DA5'}
html_theme_options = {
